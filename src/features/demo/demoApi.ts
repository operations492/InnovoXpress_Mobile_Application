...
function seed(): TaskDetail[] {
  return [
    ...
    },
    {
      ...
      pickupAfter: iso(-160),
      pickupBefore: iso(-100),
      deliverAfter: iso(-100),
      deliverBefore: iso(-20),
      assignedAt: iso(-200),
      pickedUpAt: iso(-30),
      deliveredAt: null,
    ...
    },
    {
      ...
      pickupAfter: iso(-400),
      pickupBefore: iso(-350),
      deliverAfter: iso(-350),
      deliverBefore: iso(-300),
      assignedAt: iso(-430),
      pickedUpAt: iso(-380),
      deliveredAt: iso(-305),
      generalNote: null,
...
function toListRow(job: TaskDetail): DriverTask {
  return {
    ...
    pickupAfter: job.pickupAfter,
    deliverBefore: job.deliverBefore,
